...
| `.sm`                                                                  | Smaller button.                                                                                                                                                                                                                                                                                            |
| `.lg`                                                                  | Larger button.                                                                                                                                                                                                                                                                                             |
| `.p-xs`, `.dense`                                                      | Tightest padding modifier (`px-2 py-0.5`; icon `p-0.5`). Also drops the `--control-height` minimum so a chip-sized button fits a table cell or a dense toolbar; every other size and padding class keeps that floor. An icon-only `.p-xs` button gives up its `min-width` too, so size the glyph yourself. |
