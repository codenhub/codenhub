...
| `--cyber-cut`            | `.cyber`        | Size of the bevelled corner, on controls and surfaces alike. | `0.5rem`                           |
| `--cyber-glow`           | `.cyber`        | Blur of the glow.                                            | `12px`                             |
