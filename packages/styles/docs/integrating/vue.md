...
A project running Tailwind CSS v4 imports `@codenhub/styles/tw` from a CSS entry file instead of `main.ts`, using the `@tailwindcss/vite` plugin; see [Tailwind CSS v4](./tailwind.md).
